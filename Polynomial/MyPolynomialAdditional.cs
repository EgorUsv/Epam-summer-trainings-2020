...
namespace Polynomial
{
    public partial class MyPolynomial
    {
        ...
        /// <returns></returns>
        private static (double[], double[], double[,]) GetInitArrays(MyPolynomial left, MyPolynomial right)
        {
        ...
        /// <param name="right"></param>
        /// <returns></returns>
        private static MyPolynomial DividePolynomals(MyPolynomial left, MyPolynomial right)
        {
            ...
            return new MyPolynomial(result.ToArray());
        }
        /// <summary>
